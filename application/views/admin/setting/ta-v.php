<div class="unirow asd" id="mainpage">
			...
			<div class="prfbox">
				<div class="media bts-bwh">
					...
					<div class="media-body">
						...
						<div class="txtabu">pengaturan Tahun ajaran</div>
					</div>
					<div class="media-right media-middle">
						<button class="btn btn-success"><i class="fa fa-plus-circle"></i> Tambah</button>
					</div>
				</div>
				<div class="bts-ats2">
							...
							<tbody>
								...
								<?php foreach ($allta as $dfk): ?>
									<tr>
										...
										<td class="tengah fkpading">
											<a href="#"><div class="btn label label-success"><b>Lihat</b></div></a>
										</td>
									</tr>
									<?php $no++ ?>
								<?php endforeach ?>
