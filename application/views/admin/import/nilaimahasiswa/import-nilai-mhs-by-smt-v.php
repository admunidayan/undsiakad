			...
			<div class="prfbox">
				<div class="media">
					...
					<div class="media-body">
						<h4 class="media-heading">Import Nilai Mahasiswa Berdasarkan Tahun Ajaran</h4>
				...
				<div class="hasil"></div>
				<div class="bts-ats2"><label class="label label-success"><?php echo $contoh; ?></label> Jumlah data nilai ditemukan</div>
				<div class="row">
					<div class="col-md-6">
						<form action="<?php echo base_url('index.php/admin/import/nilai_mhs_by_smt/') ?>" method="post">
							<div class="input-group bts-ats">
								<span class="input-group-addon" id="basic-addon1">Masukan Tahun +1/2</span>
								<input type="text" class="form-control" name="tasmt" placeholder="contoh 20161 atau 20162">
							</div>
						</form>
					</div>
				</div>
				Data Semester yang Tampil : <?php echo @$tasmt; ?>
						...
						<?php foreach ($allnilai['result'] as $data): ?>
							<tr>
								...
								<td class="tengah fkpading">
									<?php $check = $this->Isi_m->ceknilai($data['id_kls'],$data['id_reg_pd']); ?>
									<?php if ($check==true): ?>
	...
	$(document).ready(function(){
		$("#importdata").click(function(event){
			...
			for (var i = 0; i <= loop; i++) {
				...
				$.ajax({
					url : "<?php echo base_url('index.php/isi_db/nilai_by_smt/'.$tasmt.'/'); ?>"+i*200,
					type:'get',
