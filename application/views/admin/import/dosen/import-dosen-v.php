	...
	<div class="col-md-10 unipd">
		<div class="whitebox2 fk-min bts-ats fk-min">
			<div class="prfbox">
				...
				<div class="hasil"></div>
				<div class="bts-ats2"><label class="label label-success"><?php echo $contoh; ?></label> Jumlah data Dosen Feeder | Data Siakad : <?php echo $datadb; ?></div>
					...
					<tbody>
						...
						<?php foreach ($alldosen['result'] as $data): ?>
							<tr>
								...
								<td class="fkpading"><?php echo strtoupper($data['nm_sdm']);?></td>
								...
								<td class="tengah fkpading">
									<?php $check = $this->Isi_m->cekdosen($data['id_sdm']); ?>
									<?php if ($check==true): ?>
	...
	$(document).ready(function(){
		$("#importdata").click(function(event){
			...
			for (var i = 0; i <= loop; i++) {
				...
				$.ajax({
					url : "<?php echo base_url('index.php/isi_db/dosen/'); ?>"+i*200,
					type:'get',
