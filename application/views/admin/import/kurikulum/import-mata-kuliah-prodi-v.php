			...
			<div class="prfbox">
				<div class="media">
					...
					<div class="media-right media-middle">
						<a href="<?php echo base_url('index.php/isi_db/mata_kuliah_sms/'.$id_sms) ?>" class="btn btn-success tengah"><i class="fa fa-plus"></i> Import Data Feeder</a>
					</div>
				</div>
				<div class="hasil"></div>
						...
						<?php foreach ($allmk['result'] as $data): ?>
							...
							<tr>
								...
								<td class="tengah fkpading">
									<?php if ($this->Isi_m->cekmkkur($data['id_kurikulum_sp'])==true): ?>
	...
	$(document).ready(function(){
		$("#importdata").click(function(event){
			...
			for (var i = 0; i <= loop; i++) {
				...
				$.ajax({
					url : "<?php echo base_url('index.php/isi_db/mata_kuliah_sms/'.$id_sms); ?>"+i*500,
					type:'get',
