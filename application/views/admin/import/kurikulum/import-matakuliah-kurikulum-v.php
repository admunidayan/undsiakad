			...
			<div class="prfbox">
				<div class="media">
					...
					<div class="media-right media-middle">
						<a href="<?php echo base_url('index.php/isi_db/mata_kuliah_kurikulum') ?>" class="btn btn-success tengah"><i class="fa fa-plus"></i> Import Data Feeder</a>
					</div>
				</div>
				<div class="hasil"></div>
	...
	$(document).ready(function(){
		$("#importdata").click(function(event){
			...
			for (var i = 0; i <= loop; i++) {
				...
				$.ajax({
					url : "<?php echo base_url('index.php/isi_db/mata_kuliah_kurikulum/'); ?>"+i*500,
					type:'get',
