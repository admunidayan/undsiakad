	...
	<div class="col-md-10 unipd">
		<div class="whitebox2 fk-min bts-ats">
			<div class="prfbox">
				...
				<div class="hasil"></div>
				<div class="bts-ats2"><label id="jumlah" class="label label-success"><?php echo $contoh; ?></label> Jumlah data nilai Mahasiswa Feeder | Data Siakad : <?php echo $datadb; ?></div>
	...
	$(document).ready(function(){
		$("#importdata").click(function(){
			...
			for (var i = 0; i <= loop; i++) {
				...
				$.ajax({
					url : "<?php echo base_url('index.php/isi_db/nilai_transfer/'); ?>"+i*200,
					type:'get',
