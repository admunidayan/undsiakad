			...
			<div class="prfbox">
				<div class="media">
					...
					<div class="media-right media-middle">
						<button class="btn btn-success tengah" data-toggle="modal" data-target="#modalnilai"><i class="fa fa-plus"></i> Import Data Feedera</button>
					</div>
				</div>
				<div id="hasil"></div>
				...
				<table class="bts-ats2" border="1" width="100%">
					<thead>
						<tr>
							...
							<th rowspan="2" class="tengah fkpading">TMPT LHR</th>
							<th rowspan="2" class="tengah fkpading">TGL LHR</th>
							<th rowspan="2" class="tengah fkpading">NO HP</th>
					...
					<tbody id="reloadprodi">
						...
						<?php foreach ($hasil['result'] as $data): ?>
							<tr>
								...
								<td class="fkpading"><?php echo $data['no_hp']; ?></td>
								<td class="tengah fkpading"><?php echo $data['id_agama']; ?></td>
								<td class="tengah fkpading">
									<?php if ($this->Isi_m->cekmhs($data['id_pd'] == TRUE)): ?>
	...
	$(document).ready(function(){
		$("#importdata").click(function(event){
			...
			for (var i = 0; i <= loop; i++) {
				...
				$.ajax({
					url : "<?php echo base_url('index.php/isi_db/mahasiswa_by_mahasiswa_pt/'); ?>"+i*200,
					type:'get',
